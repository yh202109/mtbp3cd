...
import mtbp3cd.gui.tabstarting as tabstarting, mtbp3cd.gui.tabfolder as tabfolder, mtbp3cd.gui.tabchecksum as tabchecksum 
...
class MainWedge(QWidget):
    def __init__(self):
        ...
        self.tab_starting = tabstarting.TabStarting()
        self.tab_folder = tabfolder.TabFolder(self)
        self.tab_checksum = tabchecksum.TabChecksum(self)
